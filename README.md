...
| | Direct Remotion | Direct HTML | A2TL-Video |
|---|---|---|---|
...
A2TL-Video is designed to be generated by AI agents. An agent reads documentation/content and produces a `.vdsl` file using ~400 tokens. Compare:
